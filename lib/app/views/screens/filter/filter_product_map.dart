...
class FilterProductMap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final CameraPosition _kGooglePlex = CameraPosition(
      target: mapController.location_current,/*LatLng(21.021269086008136, 105.83777770400047),*/
      zoom: 14.4746,
    );
          ...
          Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Danh sách cửa hàng bạn cần tìm",
                    ...
                    return GestureDetector(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            Text(
                              "số 2 Phố Trần Hữu Dực, Mỹ Đình, Từ Liêm, Hà Nội",
                              style: TextStyle(
