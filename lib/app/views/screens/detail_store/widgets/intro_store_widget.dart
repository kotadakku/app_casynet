        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text("Giờ mở cửa  "),
              controller.store.value.time_open == 'null' ||  controller.store.value.time_close == 'null' ? Text("Đang tải ...") :
              Text("${controller.store.value.time_open}  -  ${controller.store.value.time_close}",
                style: TextStyle(
          ...
          Row(
            children: [
              ...
              Text("Điện thoại  "),
              Text(controller.store.value.phone.toString(),
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                ),
              ),
          ...
          Row(
            ...
            children: [
              ...
              Expanded(child: Text(controller.store.value.address.toString()),)
            ],
          ),
          //Thống kê
          Container(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          controller.store.value.total_product.toString() == 'null'? Text("Đang tải ..."):
                          Text(controller.store.value.total_product.toString(), style: TextStyle(
                              color: kYellowColor,
                              fontSize: 16,
                              fontWeight: FontWeight.bold
                          ),)
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Text("Tham gia: "),
                Text(controller.store.value.participation_time??'Chưa có thông tin',
                  style: TextStyle(
                      fontWeight: FontWeight.bold
                  ),
                ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text(controller.store.value.rate.toString(),
                      style: TextStyle(
                          fontWeight: FontWeight.bold
                      ),
                    ),
                ...
                Row(
                  children: [
                    ...
                    Text("Báo xấu: "),
                    Text('${controller.store.value.bad_message??0}',
                      style: TextStyle(
                          fontWeight: FontWeight.bold
                      ),
                    )
